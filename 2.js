...
class Book {
  ...
  describe() {
    return `"Книга: ${title}, автор: ${author}, колір обкладинки: ${coverColor}"`;
  }
}
...
class AudioBook {
  ...
  describe() {
    return `"Аудіокнига: ${title}, автор: ${author}, тривалість: ${audioLength}"`;
  }
}
